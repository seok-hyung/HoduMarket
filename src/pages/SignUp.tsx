...
import { buyerSignUpAPI } from 'api/user/buyerSignUpAPI';
import { sellerSignUpAPI } from 'api/user/sellerSignUpAPI';
...
const SignUp = () => {
  ...
  const buyerMutation = useMutation(buyerSignUpAPI, {
    onSuccess: (data) => {
      navigate('/login');
    },
    onError: (error) => {
  ...
  const sellerMutation = useMutation(sellerSignUpAPI, {
    onSuccess: (data) => {
      navigate('/login');
    },
    onError: (error) => {
